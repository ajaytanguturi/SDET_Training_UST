...
test("To validate the sorting functionality by Duration to give trains from low to high duration times",async({page})=>{
    ...
    // To locate the Duration(Low to high times trains)
    const durationAsc=page.locator("//button[contains(@class,'sortActive')and .//img[@alt='Sort ascending']]");
    await expect(durationAsc).toBeVisible();
